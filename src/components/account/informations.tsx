...
function Informations() {
    ...
    return (
        <>
            <h3 className='text-3xl font-medium text-center md:text-left'>Personal Information</h3>
            <p className='text-sm font-thin text-center md:text-left mb-6 md:mb-3'>Manage your account information, including phone numbers and email where you can be contacted</p>
