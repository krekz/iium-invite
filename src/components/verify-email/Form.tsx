    ...
    const verifyEmailMutation = useMutation({
        ...
        onError: (error) => {
            if (axios.isAxiosError(error)) {
                ...
                console.error('Verification error:', responseData?.message || error.message);
                ...
                {cooldown > 0 ? (
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm">
                            Time remaining: <span className="font-medium text-blue-500">{formatTime(cooldown)}</span>
                        </p>
                    ...
                    <>
                        <div className="text-center">
                            ...
                            <p className="mt-2 text-sm">
                                Enter your IIUM email to verify your account before you can submit an event
                            </p>
                            {attempts > 0 && (
                                <p className="mt-2 text-sm text-red-600">
                                    {getAttemptsMessage()}
                        ...
                        <form onSubmit={handleSubmit((email) => verifyEmailMutation.mutate(email))} className="mt-6">
