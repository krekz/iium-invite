            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                {[...Array(4)].map((_, index) => (
                    <div key={index} className="flex flex-col gap-1">
                        <div className="h-4 w-1/4 bg-white/20 rounded animate-pulse"></div>
                ...
                <div className="flex flex-col gap-1 mt-2">
                    <div className="h-4 w-1/6 bg-white/20 rounded animate-pulse"></div>
                    <div className="flex flex-wrap gap-1">
                        {[...Array(3)].map((_, index) => (
                            <div key={index} className="h-6 w-20 bg-white/20 rounded-full animate-pulse"></div>
                        ))}
                    </div>
                </div>
                ...
                <div className="space-y-1 mt-4">
                    {[...Array(3)].map((_, index) => (
                        <div key={index} className="h-10 bg-white/20 rounded animate-pulse"></div>
                    ))}
                </div>
